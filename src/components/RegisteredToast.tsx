...
export function RegisteredToast({
  ...
  return (
    <div
      ...
      className="flex w-full items-center justify-between rounded-full border border-white/10 bg-primary px-2 py-2 shadow-[0_8px_30px_rgb(0,0,0,0.12)] backdrop-blur-md"
    >
