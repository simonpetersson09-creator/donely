...
const sv = {
  ...
  premiumUnlockAll: "Lås upp alla funktioner för 29 kr/månad.",
...
const en: Dict = {
  ...
  premiumUnlockAll: "Unlock all features for 29 SEK/month.",
...
const de: Dict = {
  ...
  premiumUnlockAll: "Alle Funktionen für 29 SEK/Monat freischalten.",
...
const fr: Dict = {
  ...
  premiumUnlockAll: "Débloquez toutes les fonctionnalités pour 29 SEK/mois.",
...
const es: Dict = {
  ...
  premiumUnlockAll: "Desbloquea todas las funciones por 29 SEK/mes.",
...
const it: Dict = {
  ...
  premiumUnlockAll: "Sblocca tutte le funzioni per 29 SEK/mese.",
...
const ptBR: Dict = {
  ...
  premiumUnlockAll: "Desbloqueie todos os recursos por 29 SEK/mês.",
...
const nl: Dict = {
  ...
  premiumUnlockAll: "Ontgrendel alle functies voor 29 SEK/maand.",
...
const pl: Dict = {
  ...
  premiumUnlockAll: "Odblokuj wszystkie funkcje za 29 SEK/miesiąc.",
...
const da: Dict = {
  ...
  premiumUnlockAll: "Lås op for alle funktioner for 29 SEK/måned.",
...
const no: Dict = {
  ...
  premiumUnlockAll: "Lås opp alle funksjoner for 29 SEK/måned.",
...
const fi: Dict = {
  ...
  premiumUnlockAll: "Avaa kaikki ominaisuudet hintaan 29 SEK/kk.",
...
const ja: Dict = {
  ...
  premiumUnlockAll: "すべての機能を月額29 SEKで利用できます。",
