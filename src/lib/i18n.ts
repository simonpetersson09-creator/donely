...
const sv = {
  ...
  private: "Privat",
  category: "Kategori",
  todoPickCategory: "Vilken aktivitet?",
  todoPointHint: "1 poäng registreras på vald aktivitet",
  amount: "Antal",
  ...
  yearlyGoals: "Årsmål",
  yearlyGoalsSubtitle: "Skriv ner dina mål för året och bocka av dem när de är klara.",
  weeklyTodos: "Veckans lista",
  week: "vecka",
  weeklyTodosSubtitle: "Planera veckans uppgifter och bocka av dem när de är klara.",
  weeklyTasksCount_one: "{{count}} uppgift",
  weeklyTasksCount_other: "{{count}} uppgifter",
...
const en: Dict = {
  ...
  private: "Personal",
  category: "Category",
  todoPickCategory: "Which activity?",
  todoPointHint: "1 point is added to the chosen activity",
  amount: "Amount",
  ...
  yearlyGoalsSubtitle: "Write down your goals for the year and tick them off when done.",
  weeklyTodos: "Weekly list",
  week: "week",
  weeklyTodosSubtitle: "Plan this week's tasks and tick them off when done.",
  weeklyTasksCount_one: "{{count}} task",
  weeklyTasksCount_other: "{{count}} tasks",
  activeTodos: "Active tasks",
  completedTodos: "Completed",
  emptyTodos: "No tasks yet. Tap below to add one.",
  addTodo: "Add task",
  todoPlaceholder: "Write a task…",
  doneEditing: "Done",
  archiveTodosEmpty: "No completed tasks yet.",
  halfYear1: "H1",
  halfYear2: "H2",
  halfYear1Range: "Jan–Jun",
  halfYear2Range: "Jul–Dec",
...
const de: Dict = {
  ...
  private: "Privat",
  category: "Kategorie",
  todoPickCategory: "Welche Aktivität?",
  todoPointHint: "1 Punkt wird der gewählten Aktivität gutgeschrieben",
  amount: "Anzahl",
  ...
  yearlyGoalsSubtitle: "Schreibe deine Jahresziele auf und hake sie ab, wenn sie erledigt sind.",
  weeklyTodos: "Wochenliste",
  week: "Woche",
  weeklyTodosSubtitle: "Plane die Aufgaben der Woche und hake sie ab, wenn sie erledigt sind.",
  weeklyTasksCount_one: "{{count}} Aufgabe",
  weeklyTasksCount_other: "{{count}} Aufgaben",
  activeTodos: "Aktive Aufgaben",
  completedTodos: "Erledigt",
  emptyTodos: "Noch keine Aufgaben. Tippe unten, um eine hinzuzufügen.",
  addTodo: "Aufgabe hinzufügen",
  todoPlaceholder: "Aufgabe eingeben…",
  doneEditing: "Fertig",
  archiveTodosEmpty: "Noch keine erledigten Aufgaben.",
  halfYear1: "H1",
  halfYear2: "H2",
  ...
  shareWorkSummarySubject: "Wöchentliche Arbeitszusammenfassung ({{range}})",
  shareWorkSummaryEmpty: "Diese Woche gibt es keine Arbeitsaktivitäten zum Senden.",
  shareWorkSummaryFailed: "Teilen konnte nicht geöffnet werden.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const fr: Dict = {
  ...
  private: "Personnel",
  category: "Catégorie",
  todoPickCategory: "Quelle activité ?",
  todoPointHint: "1 point est ajouté à l'activité choisie",
  amount: "Quantité",
  distanceKm: "Distance (km)",
  ...
  yearlyGoalsSubtitle: "Notez vos objectifs de l'année et cochez-les une fois atteints.",
  weeklyTodos: "Liste de la semaine",
  week: "semaine",
  weeklyTodosSubtitle: "Planifiez les tâches de la semaine et cochez-les une fois faites.",
  weeklyTasksCount_one: "{{count}} tâche",
  weeklyTasksCount_other: "{{count}} tâches",
  activeTodos: "Tâches en cours",
  completedTodos: "Terminées",
  emptyTodos: "Pas encore de tâches. Appuyez ci-dessous pour en ajouter une.",
  addTodo: "Ajouter une tâche",
  todoPlaceholder: "Écrire une tâche…",
  doneEditing: "OK",
  archiveTodosEmpty: "Aucune tâche terminée.",
  halfYear1: "S1",
  halfYear2: "S2",
  ...
  shareWorkSummarySubject: "Récapitulatif hebdomadaire de travail ({{range}})",
  shareWorkSummaryEmpty: "Aucune activité professionnelle à envoyer cette semaine.",
  shareWorkSummaryFailed: "Impossible d'ouvrir le partage.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const es: Dict = {
  ...
  private: "Personal",
  category: "Categoría",
  todoPickCategory: "¿Qué actividad?",
  todoPointHint: "Se añade 1 punto a la actividad elegida",
  amount: "Cantidad",
  ...
  yearlyGoalsSubtitle: "Anota tus objetivos del año y márcalos cuando los completes.",
  weeklyTodos: "Lista semanal",
  week: "semana",
  weeklyTodosSubtitle: "Planifica las tareas de la semana y márcalas cuando las completes.",
  weeklyTasksCount_one: "{{count}} tarea",
  weeklyTasksCount_other: "{{count}} tareas",
  activeTodos: "Tareas activas",
  completedTodos: "Completadas",
  emptyTodos: "Aún no hay tareas. Toca abajo para añadir una.",
  addTodo: "Añadir tarea",
  todoPlaceholder: "Escribe una tarea…",
  doneEditing: "Listo",
  archiveTodosEmpty: "Aún no hay tareas completadas.",
  halfYear1: "S1",
  halfYear2: "S2",
  ...
  shareWorkSummarySubject: "Resumen semanal de trabajo ({{range}})",
  shareWorkSummaryEmpty: "No hay actividades de trabajo para enviar esta semana.",
  shareWorkSummaryFailed: "No se pudo abrir el uso compartido.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const it: Dict = {
  ...
  private: "Personale",
  category: "Categoria",
  todoPickCategory: "Quale attività?",
  todoPointHint: "1 punto viene aggiunto all'attività scelta",
  amount: "Quantità",
  ...
  yearlyGoalsSubtitle: "Annota i tuoi obiettivi dell'anno e spuntali quando li raggiungi.",
  weeklyTodos: "Lista settimanale",
  week: "settimana",
  weeklyTodosSubtitle: "Pianifica le attività della settimana e spuntale quando le completi.",
  weeklyTasksCount_one: "{{count}} attività",
  weeklyTasksCount_other: "{{count}} attività",
  activeTodos: "Attività in corso",
  completedTodos: "Completate",
  emptyTodos: "Ancora nessuna attività. Tocca qui sotto per aggiungerne una.",
  addTodo: "Aggiungi attività",
  todoPlaceholder: "Scrivi un'attività…",
  doneEditing: "Fatto",
  archiveTodosEmpty: "Nessuna attività completata.",
  halfYear1: "S1",
  halfYear2: "S2",
  ...
  shareWorkSummarySubject: "Riepilogo settimanale di lavoro ({{range}})",
  shareWorkSummaryEmpty: "Nessuna attività lavorativa da inviare questa settimana.",
  shareWorkSummaryFailed: "Impossibile aprire la condivisione.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const ptBR: Dict = {
  ...
  private: "Pessoal",
  category: "Categoria",
  todoPickCategory: "Qual atividade?",
  todoPointHint: "1 ponto é adicionado à atividade escolhida",
  amount: "Quantidade",
  ...
  yearlyGoalsSubtitle: "Anote suas metas do ano e marque-as quando concluí-las.",
  weeklyTodos: "Lista semanal",
  week: "semana",
  weeklyTodosSubtitle: "Planeje as tarefas da semana e marque-as quando concluí-las.",
  weeklyTasksCount_one: "{{count}} tarefa",
  weeklyTasksCount_other: "{{count}} tarefas",
  activeTodos: "Tarefas ativas",
  completedTodos: "Concluídas",
  emptyTodos: "Ainda sem tarefas. Toque abaixo para adicionar uma.",
  addTodo: "Adicionar tarefa",
  todoPlaceholder: "Escreva uma tarefa…",
  doneEditing: "Concluir",
  archiveTodosEmpty: "Nenhuma tarefa concluída.",
  halfYear1: "S1",
  halfYear2: "S2",
  halfYear1Range: "jan.–jun.",
  ...
  shareWorkSummarySubject: "Resumo semanal de trabalho ({{range}})",
  shareWorkSummaryEmpty: "Nenhuma atividade de trabalho para enviar esta semana.",
  shareWorkSummaryFailed: "Não foi possível abrir o compartilhamento.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const nl: Dict = {
  ...
  private: "Privé",
  category: "Categorie",
  todoPickCategory: "Welke activiteit?",
  todoPointHint: "1 punt wordt toegevoegd aan de gekozen activiteit",
  amount: "Aantal",
  ...
  yearlyGoalsSubtitle: "Schrijf je doelen voor het jaar op en vink ze af als ze klaar zijn.",
  weeklyTodos: "Weeklijst",
  week: "week",
  weeklyTodosSubtitle: "Plan de taken van de week en vink ze af als ze klaar zijn.",
  weeklyTasksCount_one: "{{count}} taak",
  weeklyTasksCount_other: "{{count}} taken",
  activeTodos: "Actieve taken",
  completedTodos: "Afgerond",
  emptyTodos: "Nog geen taken. Tik hieronder om er een toe te voegen.",
  addTodo: "Taak toevoegen",
  todoPlaceholder: "Schrijf een taak…",
  doneEditing: "Klaar",
  archiveTodosEmpty: "Nog geen afgeronde taken.",
  halfYear1: "H1",
  halfYear2: "H2",
  halfYear1Range: "jan.–jun.",
  halfYear2Range: "jul.–dec.",
  ...
  shareWorkSummarySubject: "Wekelijks werkoverzicht ({{range}})",
  shareWorkSummaryEmpty: "Deze week zijn er geen werkactiviteiten om te versturen.",
  shareWorkSummaryFailed: "Kon delen niet openen.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const pl: Dict = {
  ...
  private: "Prywatne",
  category: "Kategoria",
  todoPickCategory: "Która aktywność?",
  todoPointHint: "1 punkt zostanie dodany do wybranej aktywności",
  amount: "Liczba",
  ...
  registeredToast_one: "Zarejestrowano {{count}} {{name}}",
  registeredToast_few: "Zarejestrowano {{count}} {{name}}",
  registeredToast_many: "Zarejestrowano {{count}} {{name}}",
  registeredToast_other: "Zarejestrowano {{count}} {{name}}",
  ...
  yearlyGoalsSubtitle: "Zapisz swoje cele na rok i odhaczaj je po realizacji.",
  weeklyTodos: "Lista tygodniowa",
  week: "tydzień",
  weeklyTodosSubtitle: "Zaplanuj zadania na tydzień i odhaczaj je po wykonaniu.",
  weeklyTasksCount_one: "{{count}} zadanie",
  weeklyTasksCount_other: "{{count}} zadań",
  activeTodos: "Aktywne zadania",
  completedTodos: "Wykonane",
  emptyTodos: "Brak zadań. Dotknij poniżej, aby dodać zadanie.",
  addTodo: "Dodaj zadanie",
  todoPlaceholder: "Wpisz zadanie…",
  doneEditing: "Gotowe",
  archiveTodosEmpty: "Brak wykonanych zadań.",
  halfYear1: "P1",
  halfYear2: "P2",
  ...
  shareWorkSummarySubject: "Tygodniowe podsumowanie pracy ({{range}})",
  shareWorkSummaryEmpty: "W tym tygodniu nie ma aktywności zawodowych do wysłania.",
  shareWorkSummaryFailed: "Nie udało się otworzyć udostępniania.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const da: Dict = {
  ...
  private: "Privat",
  category: "Kategori",
  todoPickCategory: "Hvilken aktivitet?",
  todoPointHint: "1 point tilføjes den valgte aktivitet",
  amount: "Antal",
  distanceKm: "Distance (km)",
  durationMin: "Tid (min)",
  ...
  yearlyGoals: "Årsmål",
  yearlyGoalsSubtitle: "Skriv dine mål for året ned, og kryds dem af, når de er nået.",
  weeklyTodos: "Ugens liste",
  week: "uge",
  weeklyTodosSubtitle: "Planlæg ugens opgaver, og kryds dem af, når de er klare.",
  weeklyTasksCount_one: "{{count}} opgave",
  weeklyTasksCount_other: "{{count}} opgaver",
  activeTodos: "Aktive opgaver",
  completedTodos: "Afsluttede",
  emptyTodos: "Ingen opgaver endnu. Tryk nedenfor for at tilføje en.",
  addTodo: "Tilføj opgave",
  todoPlaceholder: "Skriv en opgave…",
  doneEditing: "Færdig",
  archiveTodosEmpty: "Ingen afsluttede opgaver endnu.",
  halfYear1: "H1",
  halfYear2: "H2",
  halfYear1Range: "jan.–jun.",
  halfYear2Range: "jul.–dec.",
  ...
  shareWorkSummarySubject: "Ugentlig jobopsummering ({{range}})",
  shareWorkSummaryEmpty: "Ingen arbejdsaktiviteter at sende i denne uge.",
  shareWorkSummaryFailed: "Kunne ikke åbne deling.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const no: Dict = {
  ...
  category: "Kategori",
  todoPickCategory: "Hvilken aktivitet?",
  todoPointHint: "1 poeng legges til valgt aktivitet",
  amount: "Antall",
  ...
  yearlyGoals: "Årsmål",
  yearlyGoalsSubtitle: "Skriv ned målene dine for året, og kryss dem av når de er nådd.",
  weeklyTodos: "Ukens liste",
  week: "uke",
  weeklyTodosSubtitle: "Planlegg ukens oppgaver, og kryss dem av når de er ferdige.",
  weeklyTasksCount_one: "{{count}} oppgave",
  weeklyTasksCount_other: "{{count}} oppgaver",
  activeTodos: "Aktive oppgaver",
  completedTodos: "Fullførte",
  emptyTodos: "Ingen oppgaver ennå. Trykk nedenfor for å legge til en.",
  addTodo: "Legg til oppgave",
  todoPlaceholder: "Skriv en oppgave…",
  doneEditing: "Ferdig",
  archiveTodosEmpty: "Ingen fullførte oppgaver ennå.",
  halfYear1: "H1",
  halfYear2: "H2",
  halfYear1Range: "jan.–jun.",
  ...
  shareWorkSummarySubject: "Ukentlig jobbsammendrag ({{range}})",
  shareWorkSummaryEmpty: "Ingen jobbaktiviteter å sende denne uken.",
  shareWorkSummaryFailed: "Kunne ikke åpne deling.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const fi: Dict = {
  ...
  private: "Yksityinen",
  category: "Kategoria",
  todoPickCategory: "Mikä toiminto?",
  todoPointHint: "1 piste lisätään valittuun toimintoon",
  amount: "Määrä",
  distanceKm: "Matka (km)",
  ...
  yearlyGoalsSubtitle: "Kirjoita vuoden tavoitteesi ylös ja merkitse ne tehdyiksi.",
  weeklyTodos: "Viikon lista",
  week: "viikko",
  weeklyTodosSubtitle: "Suunnittele viikon tehtävät ja merkitse ne tehdyiksi.",
  weeklyTasksCount_one: "{{count}} tehtävä",
  weeklyTasksCount_other: "{{count}} tehtävää",
  activeTodos: "Käynnissä olevat tehtävät",
  completedTodos: "Valmiit",
  emptyTodos: "Ei vielä tehtäviä. Napauta alta lisätäksesi yhden.",
  addTodo: "Lisää tehtävä",
  todoPlaceholder: "Kirjoita tehtävä…",
  doneEditing: "Valmis",
  archiveTodosEmpty: "Ei vielä valmiita tehtäviä.",
  halfYear1: "1. puol.",
  halfYear2: "2. puol.",
  ...
  shareWorkSummarySubject: "Viikon työyhteenveto ({{range}})",
  shareWorkSummaryEmpty: "Tällä viikolla ei ole työsuorituksia lähetettäväksi.",
  shareWorkSummaryFailed: "Jakamista ei voitu avata.",
  shareWorkSummaryTotal: "Total: {{count}}",
...
const ja: Dict = {
  ...
  private: "プライベート",
  category: "カテゴリー",
  todoPickCategory: "どのアクティビティ？",
  todoPointHint: "選んだアクティビティに1ポイント追加されます",
  amount: "件数",
  distanceKm: "距離 (km)",
  durationMin: "時間 (分)",
  ...
  yearlyGoals: "年間目標",
  yearlyGoalsSubtitle: "今年の目標を書き出し、達成したらチェックしましょう。",
  weeklyTodos: "今週のリスト",
  week: "週",
  weeklyTodosSubtitle: "今週のタスクを計画し、完了したらチェックしましょう。",
  weeklyTasksCount_one: "{{count}} 件",
  weeklyTasksCount_other: "{{count}} 件",
  activeTodos: "進行中のタスク",
  completedTodos: "完了済み",
  emptyTodos: "まだタスクがありません。下をタップして追加してください。",
  addTodo: "タスクを追加",
  todoPlaceholder: "タスクを入力…",
  doneEditing: "完了",
  archiveTodosEmpty: "完了したタスクはまだありません。",
  halfYear1: "上期",
  halfYear2: "下期",
  ...
  shareWorkSummarySubject: "今週の業務サマリー（{{range}}）",
  shareWorkSummaryEmpty: "今週は送信できる仕事の記録がありません。",
  shareWorkSummaryFailed: "共有を開けませんでした。",
  shareWorkSummaryTotal: "Total: {{count}}",
