...
const sv = {
  ...
  historySection: "Lägg till tidigare år",
  historyIntro: "Lägg in en totalsumma per kategori för ett tidigare år, t.ex. 150 löppass 2025.",
  historyYear: "År",
  ...
  recordBestDay: "Dagsrekord",
  recordBestWeek: "Veckorekord",
  recordBestMonth: "Månadsrekord",
  periodThisDay: "idag",
...
const en: Dict = {
  ...
  historySection: "Add previous years",
  historyIntro: "Add a total per category for a previous year, e.g. 150 runs in 2025.",
  historyYear: "Year",
  historyAdd: "Add",
  ...
  recordBestDay: "Day record",
  recordBestWeek: "Week record",
  recordBestMonth: "Month record",
  periodThisDay: "today",
...
const de: Dict = {
  ...
  recordsShow: "Anzeigen",
  recordsHide: "Ausblenden",
  ...
  recordBestDay: "Tagesrekord",
  recordBestWeek: "Wochenrekord",
  recordBestMonth: "Monatsrekord",
  periodThisDay: "heute",
...
const fr: Dict = {
  ...
  recordBestDay: "Record du jour",
  recordBestWeek: "Record de la semaine",
  recordBestMonth: "Record du mois",
...
const es: Dict = {
  ...
  historySection: "Añadir años anteriores",
  historyIntro: "Añade un total por categoría de un año anterior, p. ej. 150 carreras en 2025.",
  historyYear: "Año",
  historyAdd: "Añadir",
  ...
  recordBestDay: "Récord del día",
  recordBestWeek: "Récord de la semana",
  recordBestMonth: "Récord del mes",
  periodThisDay: "hoy",
...
const it: Dict = {
  ...
  historySection: "Aggiungi anni precedenti",
  historyIntro: "Aggiungi un totale per categoria di un anno precedente, es. 150 corse nel 2025.",
  historyYear: "Anno",
  historyAdd: "Aggiungi",
  ...
  recordBestDay: "Record del giorno",
  recordBestWeek: "Record della settimana",
  recordBestMonth: "Record del mese",
  periodThisDay: "oggi",
...
const ptBR: Dict = {
  ...
  historySection: "Adicionar anos anteriores",
  historyIntro: "Adicione um total por categoria de um ano anterior, ex.: 150 corridas em 2025.",
  historyYear: "Ano",
  ...
  recordBestDay: "Recorde do dia",
  recordBestWeek: "Recorde da semana",
  recordBestMonth: "Recorde do mês",
  periodThisDay: "hoje",
  periodThisWeek: "esta semana",
...
const nl: Dict = {
  ...
  recordBestDay: "Dagrecord",
  recordBestWeek: "Weekrecord",
  recordBestMonth: "Maandrecord",
...
const pl: Dict = {
  ...
  historySection: "Dodaj poprzednie lata",
  historyIntro: "Dodaj sumę na kategorię za poprzedni rok, np. 150 biegów w 2025.",
  historyYear: "Rok",
  historyAdd: "Dodaj",
  ...
  recordBestDay: "Rekord dnia",
  recordBestWeek: "Rekord tygodnia",
  recordBestMonth: "Rekord miesiąca",
...
const da: Dict = {
  ...
  historySection: "Tilføj tidligere år",
  historyIntro: "Tilføj en total pr. kategori for et tidligere år, fx 150 løbeture i 2025.",
  historyYear: "År",
  historyAdd: "Tilføj",
  ...
  recordBestDay: "Dagsrekord",
  recordBestWeek: "Ugens rekord",
  recordBestMonth: "Månedsrekord",
  periodThisDay: "i dag",
...
const fi: Dict = {
  ...
  recordBestDay: "Päivän ennätys",
  recordBestWeek: "Viikon ennätys",
  recordBestMonth: "Kuukauden ennätys",
...
const ja: Dict = {
  ...
  historySection: "過去の年を追加",
  historyIntro: "過去の年のカテゴリー合計を追加します（例：2025年に150回のランニング）。",
  historyYear: "年",
  historyAdd: "追加",
  ...
  recordBestDay: "1日の記録",
  recordBestWeek: "1週間の記録",
  recordBestMonth: "1ヶ月の記録",
  periodThisDay: "今日",
  periodThisWeek: "今週",
  periodThisMonth: "今月",
